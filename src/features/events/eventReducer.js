import { CLEAR_COMMENTS, CLEAR_EVENTS, CREATE_EVENT, DELETE_EVENT, FETCH_EVENTS, LISTEN_TO_EVENT_CHAT, LISTEN_TO_SELECTED_EVENT, UPDATE_EVENT } from './eventConstants'
...
const eventReducer = (state = initialState, { type, payload }) => {
    switch (type) {
        ...
        case FETCH_EVENTS:
            return { ...state, events: [...state.events, ...payload.events], moreEvents: payload.moreEvents }
